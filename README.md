...
See the full [v4.18.0 release notes](https://github.com/taracodlabs/aiden/releases/tag/v4.18.0).

<details>
<summary><strong>Earlier v4 release highlights — v4.17 through v4.5</strong></summary>
...
Full v4.5 internals: [`docs/v4.5/`](docs/v4.5/).
...
Detailed historical diagrams and module maps remain available in [`docs/v4.5/architecture.md`](docs/v4.5/architecture.md).
...
Skills live in [`skills/`](skills/) under Apache-2.0. PRs are welcome.
...
See [`docs/v4.5/daemon-windows.md`](docs/v4.5/daemon-windows.md). Foreground execution with `aiden daemon start` is recommended for initial testing.

<br>

## Troubleshooting

Common issues live in [`docs/v4.5/troubleshooting.md`](docs/v4.5/troubleshooting.md).
...
- **Core runtime:** [AGPL-3.0](LICENSE). You can self-host, modify, and distribute Aiden as long as covered modifications remain under the AGPL.
...
- **Sponsors and investors** — Aiden is built by one person and funded through client work. To help it grow faster, contact [contact@taracod.com](mailto:contact@taracod.com) or sponsor through [Razorpay](https://razorpay.me/@whitelotus9625).
